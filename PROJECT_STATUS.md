...
Primeira fatia da Fatia 4 ("lista de espera"): cadastro, compatibilidade com vagas e conversão em agendamento — os três primeiros itens do roadmap. "Indicadores básicos" (o quarto item) fica para uma rodada futura, possivelmente junto de uma ampliação do dashboard, seguindo o padrão já usado nas rodadas anteriores de entregar cada capacidade em fatias.
